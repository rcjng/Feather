...
public class TestWaveEspresso {
    ...
    public void testWaveEspresso() {
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.mocking_input_view),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("sdfsd-098ssdf-sdfsdf,,,,\nBill,,,,\ntestphoto,,,,\n2022,WI,CSE,110,Large\n"), closeSoftKeyboard());

        ViewInteraction materialTextView = onView(
                allOf(withId(R.id.self_profile_id_view), withText("f257a20d-2732-44a0-bbff-24a6025f1c9f"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.mocking_input_view), withText("sdfsd-098ssdf-sdfsdf,,,,\nBill,,,,\ntestphoto,,,,\n2022,WI,CSE,110,Large\n"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("sdfsd-098ssdf-sdfsdf,,,,\nBill,,,,\ntestphoto,,,,\n2022,WI,CSE,110,Large\nf257a20d-2732-44a0-bbff-24a6025f1c9f,wave,,,"));
