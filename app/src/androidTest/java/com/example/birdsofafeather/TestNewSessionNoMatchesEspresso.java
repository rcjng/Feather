...
public class TestNewSessionNoMatchesEspresso {
    ...
    public void testNewSessionNoMatchesEspresso() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.session_name_input_view),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("CSE 110"), closeSoftKeyboard());
        ...
        ViewInteraction recyclerView = onView(
                allOf(withId(R.id.matches_view),
