...
public class TestMimicBluetoothWave {
    ...
    public void bluetoothConnectivity() {
        ...
        String message = "a4ca50b6-941b-11ec-b909-0242ac120002,,,,\n" +
                ...
                p1.getProfileId() + ",wave,,,";

        parseInfo(message);

        assertEquals(1, db.profileDao().getWavingProfiles(true).size());
        assertEquals("a4ca50b6-941b-11ec-b909-0242ac120002", db.profileDao().getWavingProfileIds(true).get(0));
        ...
        assertEquals(2, db.profileDao().getWavingProfiles(true).size());
        assertEquals("b5zw60b6-941b-11ec-b909-0242ad120062", db.profileDao().getWavingProfileIds(true).get(1));
    ...
    protected void parseInfo(String info) {
        ...
        for (int i = 1; i < classInfo.length; i++) {
            ...
            if (classInfoSeparated[1].equals("wave")) {
                Profile waveProf = db.profileDao().getProfile(UUID);
                waveProf.setIsWaving(true);
                db.profileDao().update(waveProf);
                continue;
            }
